...
# Create the agent with code execution enabled
agent = create_pandas_dataframe_agent(
    llm=model,
    df=df,
    verbose=True,
    agent_executor_kwargs={"handle_parsing_errors": True},  # Optional, helps avoid minor issues
    allow_dangerous_code=True  # ✅ Required for executing code like df['column'].mean()
)

# Ask a question
res = agent.invoke("What is the average Base_Salary?")
print(res["output"])
